...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    return tree(label(t), [replace_loki_at_leaf(tree, lokis_replacement) for tree in branches(t)])
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    return get_name(city_a if distance(make_city("temp", lat, lon), city_a) < distance(make_city("temp", lat, lon), city_b) else city_b)
